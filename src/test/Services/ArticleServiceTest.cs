...
public class ArticleServiceTest
{
    ...
    public void TestUpdateArticle_WhenArticleToUpdateDoesNotExist_ThrowsArticleDoesNotExistException()
    {
        ...
        Action act = () => _articleService.UpdateArticle(Guid.NewGuid(), articleDTO);
    ...
    public void TestUpdateArticle_WhenArticleToUpdateExistsAndIsbnNotNull_UpdatesBookAttributes()
    {
        ...
        _articleService.UpdateArticle(Guid.NewGuid(), articleDTO);
...
public void TestUpdateArticle_StateTransitions_HandledCorrectly(ArticleState initialState, ArticleState? newState, bool shouldSucceed)
{
    ...
    public void TestGetArticleInfoExtended_WhenArticleDoesNotExist_ThrowsArticleDoesNotExistException()
    {
        ...
        Action act = () => _articleService.GetArticleInfoExtended(Guid.NewGuid());
    ...
    public void TestGetArticleInfoExtended_WhenArticleExists_CallsValidateState(ArticleState state)
    {
        ...
        _articleService.GetArticleInfoExtended(Guid.NewGuid());
...
public void TestGetArticleInfoExtended_WhenArticleExists_ReturnsArticleDTO(ArticleState state)
{
    ...
    var resultDTO = _articleService.GetArticleInfoExtended(Guid.NewGuid());
    ...
    public void TestSearchArticles_WhenNoResults_ThrowsSearchHasGivenNoResultsException()
    {
        ...
        Action act = () => _articleService.SearchArticles(null, null, null, null, null, null, null, null, null, null, 0, 0);
        ...
        string director, List<Article> expectedResult, Type daoClass)
    {
        ...
        var result = _articleService.SearchArticles(isbn, issn, isan, title, genre, publisher, yearEdition, author, issueNumber, director, 0, 0);
    ...
    public void TestSearchArticles_WhenArticleIsBooked_PerformsValidateState() {
        ...
        _articleService.SearchArticles(null, null, null, null, null, null, null, null, null, null, 0, 0);
    ...
    {
        _articleService.CountArticles("1234567890", null, null, null, null, null, null, null, null, null);
    ...
    {
        _articleService.CountArticles(null, "9876543210", null, null, null, null, null, null, null, null);
    ...
    {
        _articleService.CountArticles(null, null, "1357924680", null, null, null, null, null, null, null);
    ...
    {
        _articleService.CountArticles(null, null, null, "Some Title", "Some Genre", "Some Publisher", DateTime.Now, "Some Author", 1, "Some Director");
    ...
    public void TestRemoveArticle_WhenArticleDoesNotExist_ThrowsArticleDoesNotExistException()
    {
        ...
        Action act = () => _articleService.RemoveArticle(Guid.NewGuid());
