...
{
    public class ArticleService(IArticleDao articleDao, IBookDao bookDao, IMagazineDao magazineDao, IMovieDVDDao movieDVDDao, IBookingDao bookingDao, ILoanDao loanDao) : IArticleService
    {
